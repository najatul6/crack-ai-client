...
const Footer = () => {
  return (
    <footer className="bg-gray-900 p-10 mt-5 tracking-wide">
      ...
      <p className='text-gray-300 text-sm mt-10'>&copy; <Link to="https://najatul-islam.vercel.app" target="_blank">Najatul islam</Link>. All rights reserved.
      </p>
    </footer>
  )
}
